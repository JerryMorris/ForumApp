var FF1;
(function (FF1) {
    angular.module('FF1', ['ngRoute', 'ngResource',]).config(function ($routeProvider, $locationProvider) {
        $routeProvider
            .when('/', {
    ...
    angular.module('FF1').factory('authInterceptor', function ($q, $window, $location) {
        return ({
